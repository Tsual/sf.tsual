...
package sf.uds.util.tquery.common;

import sf.uds.util.tquery.interfaces.exec.IRunnable;

import java.util.*;

public abstract class AbstractIterator<T> implements sf.uds.util.tquery.interfaces.preview.Iterator<T>
{
	...
	@Override
	public sf.uds.util.tquery.interfaces.preview.Iterator<T> foreach(IRunnable<T> del) throws Exception
	{
		for (T t : this)
			del.run(t);
		return this;
