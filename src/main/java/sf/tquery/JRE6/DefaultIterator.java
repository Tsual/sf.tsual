...
class DefaultIterator<T> extends VirtualIterator<T> implements sf.tquery.interfaces.Iterator<T>
{
	...
	@Override
	public <V> sf.tquery.interfaces.Iterator<V> as(final ITypeConverter<T, V> tvTypeConverter)
	{
		if (_InnerIt == null) return null;
	...
	@Override
	public sf.tquery.interfaces.Iterator<T> where(ISelector<T> tSelector)
	{
	...
	@Override
	public sf.tquery.interfaces.Iterator<T> any(ISelector<T> tSelector, IRunnable<sf.tquery.interfaces.Iterator<T>> runnable) throws Exception
	{
		if (tSelector instanceof IBaseContext)
			this.vauExecutable((IBaseContext) tSelector);
	...
	@Override
	public sf.tquery.interfaces.Iterator<T> first(ISelector<T> tSelector, IRunnable<T> del) throws Exception
	{
		if (tSelector instanceof IBaseContext)
			this.vauExecutable((IBaseContext) tSelector);
	...
	@Override
	public sf.tquery.interfaces.Iterator<T> foreach(IRunnable<T> del) throws Exception
	{
		if (del instanceof IBaseContext)
			this.vauExecutable((IBaseContext) del);
	...
	@Override
	public sf.tquery.interfaces.Iterator<T> executeWithList(IRunnable<List<T>> del) throws Exception
	{
		if (del instanceof IBaseContext)
			this.vauExecutable((IBaseContext) del);
		if (del != null)
	...
	@Override
	public sf.tquery.interfaces.Iterator<T> executeWithIterator(IRunnable<sf.tquery.interfaces.Iterator<T>> del) throws Exception
	{
		if (del instanceof IBaseContext)
			this.vauExecutable((IBaseContext) del);
		if (del != null)
	...
	@Override
	public sf.tquery.interfaces.Iterator<T> context(IRunnable<Map> del) throws Exception
	{
		if (del instanceof IBaseContext)
			this.vauExecutable((IBaseContext) del);
		if (del != null)
	...
	@Override
	public <V> sf.tquery.interfaces.Iterator<V> reset(Class<V> vClass, ITypeConverter<sf.tquery.interfaces.Iterator, sf.tquery.interfaces.Iterator<V>> failConverter) throws Exception
	{
		...
		try {
			return (sf.tquery.interfaces.Iterator<V>) ((DefaultIterator) _InnerIt)._InnerIt;
		} catch (ClassCastException ex) {
			if (failConverter != null) {
				return failConverter.execute((sf.tquery.interfaces.Iterator) ((DefaultIterator) _InnerIt)._InnerIt);
			} else {
				throw ex;
			}
		}
	...
	@Override
	public <V> V cast(ITypeConverter<sf.tquery.interfaces.Iterator<T>, V> failConverter) throws Exception
	{
		try {
			return (V) this;
		} catch (ClassCastException ex) {
	...
	@Override
	public <V> sf.tquery.interfaces.Iterator<V> convert(ITypeConverter<T, V> tvTypeConverter) throws Exception
	{
		if (tvTypeConverter instanceof IBaseContext)
			this.vauExecutable((IBaseContext) tvTypeConverter);
