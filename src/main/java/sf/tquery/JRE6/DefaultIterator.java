...
class DefaultIterator<T> extends VirtualIterator<T> implements sf.tquery.interfaces.old.Iterator<T>
{
	...
	@Override
	public <V> sf.tquery.interfaces.old.Iterator<V> as(final ITypeConverter<T, V> tvTypeConverter)
	{
		if (_InnerIt == null) return null;
	...
	@Override
	public sf.tquery.interfaces.old.Iterator<T> where(ISelector<T> tSelector)
	{
	...
	@Override
	public sf.tquery.interfaces.old.Iterator<T> any(ISelector<T> tSelector, IRunnable<sf.tquery.interfaces.old.Iterator<T>> runnable) throws Exception
	{
		if (tSelector instanceof IBaseContext)
			this.vauExecutable((IBaseContext) tSelector);
	...
	@Override
	public sf.tquery.interfaces.old.Iterator<T> first(ISelector<T> tSelector, IRunnable<T> del) throws Exception
	{
		if (tSelector instanceof IBaseContext)
			this.vauExecutable((IBaseContext) tSelector);
	...
	@Override
	public sf.tquery.interfaces.old.Iterator<T> foreach(IRunnable<T> del) throws Exception
	{
		if (del instanceof IBaseContext)
			this.vauExecutable((IBaseContext) del);
	...
	@Override
	public sf.tquery.interfaces.old.Iterator<T> executeWithList(IRunnable<List<T>> del) throws Exception
	{
		if (del instanceof IBaseContext)
			this.vauExecutable((IBaseContext) del);
		if (del != null)
	...
	@Override
	public sf.tquery.interfaces.old.Iterator<T> executeWithIterator(IRunnable<sf.tquery.interfaces.old.Iterator<T>> del) throws Exception
	{
		if (del instanceof IBaseContext)
			this.vauExecutable((IBaseContext) del);
		if (del != null)
	...
	@Override
	public sf.tquery.interfaces.old.Iterator<T> context(IRunnable<Map> del) throws Exception
	{
		if (del instanceof IBaseContext)
			this.vauExecutable((IBaseContext) del);
		if (del != null)
	...
	@Override
	public <V> sf.tquery.interfaces.old.Iterator<V> reset(Class<V> vClass, ITypeConverter<sf.tquery.interfaces.old.Iterator, sf.tquery.interfaces.old.Iterator<V>> failConverter) throws Exception
	{
		...
		try {
			return (sf.tquery.interfaces.old.Iterator<V>) ((DefaultIterator) _InnerIt)._InnerIt;
		} catch (ClassCastException ex) {
			if (failConverter != null) {
				return failConverter.execute((sf.tquery.interfaces.old.Iterator) ((DefaultIterator) _InnerIt)._InnerIt);
			} else {
				throw ex;
			}
		}
	...
	@Override
	public <V> V cast(ITypeConverter<sf.tquery.interfaces.old.Iterator<T>, V> failConverter) throws Exception
	{
		try {
			return (V) this;
		} catch (ClassCastException ex) {
	...
	@Override
	public <V> sf.tquery.interfaces.old.Iterator<V> convert(ITypeConverter<T, V> tvTypeConverter) throws Exception
	{
		if (tvTypeConverter instanceof IBaseContext)
			this.vauExecutable((IBaseContext) tvTypeConverter);
